...
/// <summary>
/// Settings-menu toggle for showing/hiding the level timer panel. Persists the choice
/// to <see cref="PlayerPrefs"/> so it's remembered next time this scene loads.
/// </summary>
